...
Literal : DoubleQout (Letter|SEMICOLON|DARROW|LPAREN|RPAREN|COMMA|PLUS|MINUS|STAR|TILDE|LBRACE|RBRACE|DOT|ASSIGN|ATSYM|COLON|DoubleQout|Digit|Relop|WS)* DoubleQout;
